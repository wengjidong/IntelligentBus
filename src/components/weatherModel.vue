<template>
  ...
  <div class="weather-box">
    ...
    <div class="icon-div" @click="showWeather">
    ...
    export default {
      ...
      methods: {
        init(viewer){
          ...
          if(this.wea.indexOf('雪')>-1){
            this.getSnow();
          }
        },
        showWeather(){
          this.clickWeather=!this.clickWeather;
          if(this.clickWeather){
            if(this.wea=='雨'){
              this.getRain();

            }
            else if(this.wea.indexOf('雪')>-1){
              this.getSnow();
            }
            else{
